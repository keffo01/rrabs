...
<div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block w-100 grande" src="<?=base_url()?>/assets/images/rrabbs.png"
        alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 grande" src="<?=base_url()?>/assets/images/Venta2.png"
        alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 grande" src="<?=base_url()?>/assets/images/Venta3.png"
        alt="Third slide">
    </div>
  </div>
  <!--/.Slides-->
